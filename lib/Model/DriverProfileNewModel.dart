class DriverProfileNewModel {
  DriverProfileNewModel({
      bool? status, 
      String? message, 
      Data? data, 
      bool? success,}){
  ...
  DriverProfileNewModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  Data? _data;
  bool? _success;
  DriverProfileNewModel copyWith({  bool? status,
  String? message,
  Data? data,
  bool? success,
}) => DriverProfileNewModel(  status: status ?? _status,
  ...
  Data.fromJson(dynamic json) {
    ...
    if (json['uploads'] != null) {
      ...
      json['uploads'].forEach((v) {
        _uploads?.add(Uploads.fromJson(v));
      });
    }
  }
  num? _id;
...
Data copyWith({  num? id,
  ...
  List<Uploads>? get uploads => _uploads;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_uploads != null) {
      map['uploads'] = _uploads?.map((v) => v.toJson()).toList();
    }
    return map;
  }
...
class Uploads {
  Uploads({
      ...
      String? updatedAt,}){
    _id = id;
    _uploadsableType = uploadsableType;
    _uploadsableId = uploadsableId;
    _filePath = filePath;
    _type = type;
  ...
  Uploads.fromJson(dynamic json) {
    _id = json['id'];
    _uploadsableType = json['uploadsable_type'];
    _uploadsableId = json['uploadsable_id'];
...
Uploads copyWith({  num? id,
  ...
  uploadsableType: uploadsableType ?? _uploadsableType,
  uploadsableId: uploadsableId ?? _uploadsableId,
  ...
  num? get id => _id;
  String? get uploadsableType => _uploadsableType;
  num? get uploadsableId => _uploadsableId;
  ...
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    map['id'] = _id;
    map['uploadsable_type'] = _uploadsableType;
    map['uploadsable_id'] = _uploadsableId;
